...
public class NewsNotificationUtils {
    ...
    private static final int ACTION_NEWS_SYNC_PENDING_INTENT_ID = 1;
    ...
    public static void remindUserNewNews(Context context) {
//        Log.d("Notify", ""+context);
        NotificationManager notificationManager = (NotificationManager)
                context.getSystemService(Context.NOTIFICATION_SERVICE);
...
//                .addAction(drinkWaterAction(context))
        ...
        Log.d("Notify User", "true");
    }
    private static Action ignoreReminderAction(Context context) {
        Intent ignoreReminderIntent = new Intent(context, NewsIntentService.class);
        ignoreReminderIntent.setAction(NewsReminderTasks.ACTION_DISMISS_NOTIFICATION);
        PendingIntent ignoreReminderPendingIntent = PendingIntent.getService(
                context,
                ACTION_IGNORE_PENDING_INTENT_ID,
                ignoreReminderIntent,
                PendingIntent.FLAG_UPDATE_CURRENT);
        Action ignoreReminderAction = new Action(R.drawable.ic_cancel_blue_24px,
                "No, thanks.",
...
//        Intent incrementWaterCountIntent = new Intent(context, NewsIntentService.class);
//        incrementWaterCountIntent.setAction(NewsReminderTasks.ACTION_INCREMENT_WATER_COUNT);
//        PendingIntent incrementWaterPendingIntent = PendingIntent.getService(
//                context,
//                ACTION_NEWS_SYNC_PENDING_INTENT_ID,
...
//    }
    ...
    private static Bitmap largeIcon(Context context) {
        ...
        Bitmap largeIcon = BitmapFactory.decodeResource(res, R.drawable.ic_news_notification);
        return largeIcon;
    }
}
